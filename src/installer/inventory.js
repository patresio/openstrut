...
export const INVENTORY = [
  ...
  { source: 'global/agents/performance-optimizer.md',                        target: 'agents/performance-optimizer.md' },
  ...
  // Skills
  { source: 'global/skills/accessibility-review/SKILL.md',                   target: 'skills/accessibility-review/SKILL.md' },
  ...
  { source: 'global/skills/compliance-audit/SKILL.md',                        target: 'skills/compliance-audit/SKILL.md' },
  { source: 'global/skills/database-design/SKILL.md',                         target: 'skills/database-design/SKILL.md' },
  ...
  { source: 'global/skills/localization/SKILL.md',                            target: 'skills/localization/SKILL.md' },
  { source: 'global/skills/observability-design/SKILL.md',                    target: 'skills/observability-design/SKILL.md' },
  { source: 'global/skills/performance-engineering/SKILL.md',                 target: 'skills/performance-engineering/SKILL.md' },
  ...
  { source: 'global/skills/privacy-review/SKILL.md',                         target: 'skills/privacy-review/SKILL.md' },
  { source: 'global/skills/rag-agent-design/SKILL.md',                       target: 'skills/rag-agent-design/SKILL.md' },
  { source: 'global/skills/release-management/SKILL.md',                      target: 'skills/release-management/SKILL.md' },
